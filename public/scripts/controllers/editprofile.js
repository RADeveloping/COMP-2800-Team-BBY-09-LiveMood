	...
	bootbox.prompt({
		...
		callback  : function(result) {
			...
			if (result != null) {
				...
				credential = firebase.auth.EmailAuthProvider.credential(user.email, result);
	...
	if (user != null) {
		user.providerData.forEach(function(profile) {
			...
			if (user.emailVerified != true) {
				...
				notverifiedbar.innerHTML =
					'Email not verified. Please check your email to verify your account. <p class="verify-button" onclick="sendVerificationEmail()">Tap here to resend verification email</button>';
			}
		});
	}
}
